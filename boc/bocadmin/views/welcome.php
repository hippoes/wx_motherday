	...
	<div class="boxed span4">
		...
		<div class="boxed span4">
			<div class="boxed-inner hg1">
				...
				<ul class="boxed-list">
					<?php foreach ($boc['data'] as $k=>$v) {
						if($k+1<=6){
							echo "<li> <a target='_blank' href='".$boc['url'].$v['id'].".html'> ".$v['title']." </a> </li>";
						}
					} ?>
				</ul>
			</div>
		</div>
		<iframe src="http://www.bocweb.cn/servicecenter.php" width="100%" frameborder='0' style="height:1000px;overflow:hidden;"
		></iframe>		
	</div>
