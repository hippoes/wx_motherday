<?php if (ielt9()): ?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><?php else: ?><!DOCTYPE HTML><?php endif ?>
	...
	echo static_file('adminer/css/ui.css');
		// echo static_file('adminer/css/sidebar.css');
				...
				<div class="container">
					<ul class="nav-logo pull-left">
						...
						<ul class="nav pull-right">
							<?php // 搜索栏目中的标题  ?>
							<?php if (isset($_GET['c']) and !in_array($this->class, array('columns','page','coltypes'))): ?>
								<li>
							...
							<li class="dropdown">
								<a class="dropdown-toggle"data-toggle="dropdown" href="#" ><i class="fa fa-user"></i> <?php //echo $this->session->userdata('nickname'); ?><b class="caret"></b>
								</a>
							...
							<li>
								<a href="<?php echo site_url('login/logout')?>"><i class='fa fa-sign-out'></i> <?php echo lang('logout') ?></a>
							</li>
						</ul>
					</div>
				</div>
