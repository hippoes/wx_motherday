...
<div class="boxed">
    ...
    <div class="boxed-inner seamless">
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" class="span6" name="title" value="<?php echo set_value('title') ?>" id="title" x-webkit-speech>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" placeholder="城市名必填！" required  class="span6" name="city" value="<?php echo set_value('city') ?>" id="city" x-webkit-speech>
            </div>
        </div>
        <?php endif; ?>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" <?php if($cid!=67): ?>placeholder="类似 http://... 或 https://..."<?php endif; ?> class='span6' name="link" value="<?php echo set_value('link') ?>" id="link">
            </div>
        </div>
