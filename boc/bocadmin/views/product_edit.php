<?php
$cid=$this->cid;
$need_title1=array(45);
$need_photo=array(60,61,62,63);
...
<!--                <a href="#seo-modal" role="button" class="btn btn-info" data-toggle="modal">--><?php //echo lang('seo') ?><!--</a>-->
        ...
        <?php if (in_array($cid,$need_title1)): ?>
            <div class="control-group">
                <label class="control-label" for="title1"> 详情标题 </label>
                <div class="controls">
                    <input type="text" id="title1" name="title1" class='span7' value="<?php echo set_value("title1",$it['title1']) ?>">
                </div>
            </div>
        <?php endif; ?>
