<?php
$cid=$this->cid;
$no_flag=array(45,60,61,62,63);
$need_thumb=array(60,61,62,63);
        ...
        <table class="table table-striped table-hover select-list">
            <thead>
                <tr>
                    ...
                    <?php if(in_array($cid,$need_thumb)): ?><th>图</th><?php endif; ?>
                    <th>排序</th>
                    <th>标题</th>
                    <th>时间</th>
            ...
            <tbody class="sort-list">
                <?php foreach ($list as $v):?>
                    <tr data-id="<?php echo $v['id'] ?>" data-sort="<?php echo $v['sort_id'] ?>">
                        ...
                        <?php if(in_array($cid,$need_thumb)): ?>
                        <td>
                            <?php if ($v['thumb']): ?>
...
<script>
    require(['adminer/js/ui'],function(ui){
      var product = {
        ...
        ,url_sort_change: "<?php echo site_urlc('product/sort_change'); ?>"
        ,url_copy: "<?php echo site_urlc('product/copypro'); ?>"
    };
  ...
  ui.sort_change(product.url_sort_change); // input 排序
  ui.btn_copy(product.url_copy);    // 复制
});
</script>
