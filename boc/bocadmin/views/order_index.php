<b><a href='<?php echo site_url('order'.'?type_id=49') ?>'>会员课程</a></b>&nbsp;&nbsp;
<b><a href='<?php echo site_url('order'.'?type_id=57') ?>'>常规课程</a></b>&nbsp;&nbsp;
			...
			<tbody class="sort-list">
				<?php foreach ($list as $v):?>
					<tr data-id="<?php echo $v['id'] ?>" data-sort="<?php echo $v['sort_id'] ?>">
						...
						<td> <?php if($v['type_id']==49) echo "会员课程"; elseif($v['type_id']==57) echo "常规课程"; else echo "异常数据"; ?> </td>
