...
define('DB_USER'   , 'root');
define('DB_PASS'   , 'hbbcare!@#');
define('DB_NAME'   , 'motherday');
define('DB_PREFIX' , 'ci_');

# 全局URL路径
// 主域名 保留最后的 /
define('GLOBAL_URL'  , 'http://'.$_SERVER['HTTP_HOST'].'/');
define('GLOBAL_URL_SQL'  , 'http://'.$_SERVER['HTTP_HOST'].'/boc/');
// 提供给后台做链接用的
define('STATIC_URL'  , GLOBAL_URL.'bocweb/');
...
define('STATIC_PATH' , ROOT.'bocweb/');
