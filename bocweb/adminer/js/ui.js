...
function($,tools){
	...
	var ui = {
        ...
        btn_flag1:function(url){
            $(".select-list").delegate('.btn-ajax-flag1', 'click', function(event) {
                event.preventDefault();
                var flag = {
                    id:$(this).attr('data-id'),
                    flag:$(this).attr('data-flag1'),
                    it:$(this),
                    i:$(this).children('i')
                };
                $.ajax({
                    ...
                    .done(function(data) {
                        ...
                        if (data.status == 1 ) {
                            ...
                            if (flag.flag == 1) {
                                msg.type = 'success';
                                flag.it.addClass('btn-primary').attr({'data-flag1':'0','title':'取消推荐'});
                            }else{
                                msg.type = 'notice';
                                flag.it.removeClass('btn-primary').attr({'data-flag1':'1','title':'推荐'});
                            }
                        }else{
                            msg.title = "错误！";
                            msg.type = 'error';
