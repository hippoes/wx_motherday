...
// 图片地址在此处更换  可换成你的图片
var assets = [
    '/bocweb/web/images/mother/love-heart/1.png',
    '/bocweb/web/images/mother/love-heart/2.png',
    '/bocweb/web/images/mother/love-heart/3.png',
    '/bocweb/web/images/mother/love-heart/4.png',
    '/bocweb/web/images/mother/love-heart/5.png',
];
...
Promise.all(assets).then(function(images) {
	...
	document.getElementsByClassName('love-heart')[0].addEventListener('click', function() {
		//随机飘动
